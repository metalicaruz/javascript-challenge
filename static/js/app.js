...
function handleSearchButtonClick() {
	...
	if (filterDate && filterCity && filterState && filterCountry && filterShape) {
		filteredData = filter(data, {'datetime': filterDate, 'city': filterCity, 'state': filterState, 'country': filterCountry, 'shape': filterShape});
	}
	else if (filterDate && filterCity && filterState && filterCountry) {
		filteredData = filter(data, {'datetime': filterDate, 'city': filterCity, 'state': filterState, 'country': filterCountry});
	}
	else if (filterDate && filterCity && filterCountry && filterShape) {
		filteredData = filter(data, {'datetime': filterDate, 'city': filterCity, 'country': filterCountry, 'shape': filterShape});
	}
	else if (filterDate && filterState && filterCountry && filterShape) {
		filteredData = filter(data, {'datetime': filterDate, 'state': filterState, 'country': filterCountry, 'shape': filterShape});
	}
	else if (filterCity && filterState && filterCountry && filterShape) {
		filteredData = filter(data, {'city': filterCity, 'state': filterState, 'country': filterCountry, 'shape': filterShape});
	}
	else if (filterDate && filterCity && filterState) {
		filteredData = filter(data, {'datetime': filterDate, 'city': filterCity, 'state': filterState});
	}
	else if (filterDate && filterCity && filterCountry) {
		filteredData = filter(data, {'datetime': filterDate, 'city': filterCity, 'country': filterCountry});
	}
	else if (filterDate && filterState && filterCountry) {
		filteredData = filter(data, {'datetime': filterDate, 'state': filterState, 'country': filterCountry});
	}
	else if (filterDate && filterCountry && filterShape) {
		filteredData = filter(data, {'datetime': filterDate, 'country': filterCountry, 'shape': filterShape});
	}
	else if (filterCity && filterState && filterCountry) {
		filteredData = filter(data, {'city': filterCity, 'state': filterState, 'country': filterCountry});
	}
	else if (filterCity && filterState && filterShape) {
		filteredData = filter(data, {'city': filterCity, 'state': filterState, 'shape': filterShape});
	}
	else if (filterCity && filterCountry && filterShape) {
		filteredData = filter(data, {'city': filterCity, 'country': filterCountry, 'shape': filterShape});
	}
	else if (filterState && filterCountry && filterShape) {
		filteredData = filter(data, {'state': filterState, 'country': filterCountry, 'shape': filterShape});
	}
	else if (filterDate && filterCity) {
		filteredData = filter(data, {'datetime': filterDate, 'city': filterCity});
	}
	else if (filterDate && filterState) {
		filteredData = filter(data, {'datetime': filterDate, 'state': filterState});
	}
	else if (filterDate && filterCountry) {
		filteredData = filter(data, {'datetime': filterDate, 'country': filterCountry});
	}
	else if (filterDate && filterShape) {
		filteredData = filter(data, {'datetime': filterDate, 'shape': filterShape});
	}
	else if (filterCity && filterState) {
		filteredData = filter(data, {'city': filterCity, 'state': filterState});
	}
	else if (filterCity && filterCountry) {
		filteredData = filter(data, {'city': filterCity, 'country': filterCountry});
	}
	else if (filterCity && filterShape) {
		filteredData = filter(data, {'city': filterCity, 'shape': filterShape});
	}
	else if (filterState && filterCountry) {
		filteredData = filter(data, {'state': filterState, 'country': filterCountry});
	}
	else if (filterState && filterShape) {
		filteredData = filter(data, {'state': filterState, 'shape': filterShape});
	}
	else if (filterCountry && filterShape) {
		filteredData = filter(data, {'country': filterCountry, 'shape': filterShape});
	}
	else if (filterDate) {
		filteredData = filter(data, {'datetime': filterDate});
	}
	else if (filterCity) {
		filteredData = filter(data, {'city': filterCity});
	}
	else if (filterState) {
		filteredData = filter(data, {'state': filterState});
	}
	else if (filterCountry) {
		filteredData = filter(data, {'country': filterCountry});
	}
	else {
		filteredData = filter(data, {'shape': filterShape});
	};
